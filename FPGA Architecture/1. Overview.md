...
**Still have to pick**:
- Specific (stream) HW units (and only a few) 
- How to connect HW units to microprocessor? 
	- All read/write central storage -> flexible but central bottleneck
	- Fixed connection -> faster, cheaper but not very flexible
